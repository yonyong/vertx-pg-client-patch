...
public class DataTypeCodec {
  ...
  private static final DateTimeFormatter TIMETZ_FORMAT = new DateTimeFormatterBuilder()
  ...
  private static void textEncode(DataType id, Object value, ByteBuf buff) {
    switch (id) {
      case NUMERIC:
        textEncodeNUMERIC(NumberUtil.parseNumber(String.valueOf(value)) , buff);
        break;
      case NUMERIC_ARRAY:
        textEncodeNUMERIC_ARRAY(ArrayCastHelper.convert((Object[])value,Number.class), buff);
        break;
      case UNKNOWN:
  ...
  public static void encodeBinary(DataType id, Object value, ByteBuf buff) {
    switch (id) {
      case BOOL:
        binaryEncodeBOOL(Boolean.parseBoolean(String.valueOf(value)), buff);
        break;
      case BOOL_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Boolean.class), DataType.BOOL, buff);
        break;
      case INT2:
        binaryEncodeINT2(NumberUtil.parseNumber(String.valueOf(value)), buff);
        break;
      case INT2_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Number.class), DataType.INT2, buff);
        break;
      case INT4:
        binaryEncodeINT4(NumberUtil.parseNumber(String.valueOf(value)), buff);
        break;
      case INT4_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Number.class), DataType.INT4, buff);
        break;
      case INT8:
        binaryEncodeINT8(NumberUtil.parseNumber(String.valueOf(value)), buff);
        break;
      case INT8_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Number.class), DataType.INT8, buff);
        break;
      case FLOAT4:
        binaryEncodeFLOAT4(NumberUtil.parseNumber(String.valueOf(value)), buff);
        break;
      case FLOAT4_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Number.class), DataType.FLOAT4, buff);
        break;
      case FLOAT8:
        binaryEncodeFLOAT8(NumberUtil.parseNumber(String.valueOf(value)), buff);
        break;
      case FLOAT8_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,Number.class), DataType.FLOAT8, buff);
        break;
      case CHAR:
      ...
      case NAME_ARRAY:
        ...
        break;
      case DATE:
        binaryEncodeDATE(LocalDate.parse(String.valueOf(value)), buff);
        break;
      case DATE_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,LocalDate.class), DataType.DATE, buff);
        break;
      case TIME:
        binaryEncodeTIME(LocalTime.parse(String.valueOf(value)), buff);
        break;
      case TIME_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,LocalTime.class), DataType.TIME, buff);
        break;
      case TIMETZ:
        binaryEncodeTIMETZ((OffsetTime) value, buff);
        break;
      case TIMETZ_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,OffsetTime.class), DataType.TIMETZ, buff);
        break;
      case TIMESTAMP:
        binaryEncodeTIMESTAMP((LocalDateTime) value, buff);
        break;
      case TIMESTAMP_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,LocalDateTime.class), DataType.TIMESTAMP, buff);
        break;
      case TIMESTAMPTZ:
        binaryEncodeTIMESTAMPTZ((OffsetDateTime) value, buff);
        break;
      case TIMESTAMPTZ_ARRAY:
        binaryEncodeArray(ArrayCastHelper.convert((Object[])value,OffsetDateTime.class), DataType.TIMESTAMPTZ, buff);
        break;
      case BYTEA:
